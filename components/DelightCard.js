      ...
      <div className="px-5 py-3">
        ...
        <h4 className="text-gray-600 text-base mb-4">
          ...
          {ingredients.map(ingredient => (
            <span className="after:content-[',\0020'] last:after:content-['.']">{ingredient}</span>
          ))}
        </h4>
        ...
        <ul>
          ...
          {nutrition.map(nutrit => (
            <li className="before:content-['\2022\0020']">{nutrit}</li>
          ))}
        </ul>
        </div>
          ...
          <div className="inline-flex items-center justify-between">
            <div className="w-1/3">
              <label className="w-full hover:cursor-pointer select-none" onMouseDown={handleOrderOne}>
                <input type="radio" value="option1" checked={orderOne} />
            ...
            <div className="w-1/3">
              <label className="w-full hover:cursor-pointer select-none" onMouseDown={handleOrderFive}>
                <input type="radio" value="option2" checked={orderFive}/>
            ...
            <div className="w-1/3">
              <label className="w-full hover:cursor-pointer select-none" onMouseDown={handleOrderBulk}>
                <input type="radio" value="option3" checked={orderBulk}/>
